...
public class ConnectionFactoryDev {
    ...
    private ConnectionFactoryDev() {
        ...
        DriverManagerConnectionFactory connectionFactory = new DriverManagerConnectionFactory(
                "jdbc:mysql://ls-18bf6de031311b3e933799ef9735005aeb6b6f74.c16t0ksf3vij.ap-northeast-2.rds.amazonaws.com:3306/database-jproject-1?createDatabaseIfNotExist=true", properties
        );
    ...
    public static Connection getDatabaseConnection() throws SQLException {
        return ConnectionFactoryDev.Singleton.INSTANCE.dataSource.getConnection();
    }
}
