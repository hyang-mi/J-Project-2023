...
public class InitDevDb {
    ...
    static class InitService {
        ...
        public void initMember() {
            member1 = new Member(1L, "최가의", "god", "1111", "godgaui", c1);
            member2 = new Member(2L, "한요한", "han", "2222", "hyh", c1);
            member3 = new Member(3L, "한태산", "san", "3333", "hts", c2);
            member4 = new Member(4L, "홍향미", "hong", "4444", "hyangmeeh", c2);
            member5 = new Member(5L, "최종현", "choi", "5555", "cjh", c3);
